...
unsigned int test_unitaire_buffer_circulaire_partagee() {
	...
	init_buffer_circulaire_partagee(&bc, (uint8_t*) &buffer_fifo, TAILLE, NB_DONNEES);
	...
	if (res == 0) {
		...
		if (-1 != tmp || buffer_fifo[0][0] != 0 || bc.buffer.occupation != 0 || bc.buffer.occupation_max != 0) {
			res = i;
		}
	}
	...
	if (res == 0) {
		...
		if (0 != tmp || buffer_fifo[0][0] != 0x11 || buffer_fifo[0][1] != 0x22 || bc.buffer.occupation != 1 || bc.buffer.occupation_max != 1) {
			res = i;
		}
	}
	...
	if (res == 0) {
		...
		buffer[1] = 0;
		buffer[2] = 0;
		if (-1 != pop_partagee(&bc, buffer, TAILLE - 1) || buffer[0] != 0 || buffer[0] != 0 || bc.buffer.occupation != 1 || bc.buffer.occupation_max != 1) {
			res = i;
		}
	}
	...
	if (res == 0) {
		...
		if (2 != tmp || buffer[0] != 0x11 || buffer[1] != 0x22 || bc.buffer.occupation != 0 || bc.buffer.occupation_max != 1) {
			res = i;
		}
	}
	...
	if (res == 0) {
		...
		buffer[2] = 0;
		tmp = pop_partagee(&bc, buffer, TAILLE);
		if (-2 != tmp || buffer[0] != 0 || buffer[1] != 0 || bc.buffer.occupation != 0 || bc.buffer.occupation_max != 1) {
			res = i;
		}
	}
	...
	if (res == 0) {
		...
		res = buffer_fifo[1][1];
		res = 0;
		if (0 != tmp || buffer_fifo[1][0] != 0x11 || buffer_fifo[1][1] != 0x12 || bc.buffer.occupation != 1 || bc.buffer.occupation_max != 1) {
			res = i;
		}
	}
	if (res == 0) {
		...
		buffer[0] = 0x13;
		buffer[1] = 0x14;
		if (0 != push_partagee(&bc, buffer, TAILLE) || buffer_fifo[2][0] != 0x13 || buffer_fifo[2][1] != 0x14|| bc.buffer.occupation != 2 || bc.buffer.occupation_max != 2) {
			res = i;
		}
	}
	if (res == 0) {
		...
		buffer[0] = 0x17;
		buffer[1] = 0x18;
		if (0 != push_partagee(&bc, buffer, TAILLE) || buffer_fifo[0][0] != 0x17 || buffer_fifo[0][1] != 0x18|| bc.buffer.occupation != 3 || bc.buffer.occupation_max != 3) {
			res = i;
		}
	}
